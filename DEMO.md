...
📹 **Full video walkthrough:** [Watch on Google Drive](https://drive.google.com/drive/folders/1FU4SnpB5bf7emXI_LrXMfQkrdeLf9pO2?usp=sharing)

The video demonstrates: building the project, compiling a buggy program with and without the sanitizer, detection of type mismatches, deadlocks, collective ordering violations, a correct program with no false positives, and the full test suite run.
